...
<html>    
    ...
    <body>
        <div id="page_block">
            ...
            <div id="carrousel">
                <ul>
                        <li><img src="../pictures/maison2.jpg"/></li>
                    ...
                    <div id="fin_recherche">
                        ...
                        <div class="item">
                            ...
                            <p class="right"><input type="checkbox" name="proximite[]" value='2' id="Mer"><label for="Mer">Bord de mer</label></p>
                                ...
                                <p class="right"><input type="checkbox" name="proximite[]" value='8' id="Fitness"><label for="Fitness">Fitness</label></p>
            ...
            <aside>
                <div id="announces_block2">
                    <p id="tittre2">Resultat de votre recherche</p>
                    
                    <?php
                    if($cpt_ann_src == 0)
                    {
                        echo "Aucun résultat trouvé pour votre recherhce";
                    }
                    else
                    {
                        for($j=0; $j < $cpt_ann_src; $j++)
                        {
                            ?>
