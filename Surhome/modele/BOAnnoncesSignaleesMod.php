...
$req_count = $bdd ->query("SELECT count(ID) AS nbr FROM reclamation");
...
$req = $bdd->query("SELECT ID, id_annonce, id_utilisateur, titre, texte FROM reclamation ORDER BY ID LIMIT ".$x.",".$nbrResult);
